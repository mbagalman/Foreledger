...
- **Missing actuals return an explicit "insufficient data" result** — never a silent zero/NaN that reads as perfect accuracy.

## Permissions

Verbatim from `implementation-plan-forecast-archive.md` (Agent execution boundaries).
...
- Architecture and data model: `tech-spec-forecast-archive-final.md`
- Decisions and rationale: `adr-001`…`adr-007` (`*.md` in this directory)
- Phased plan, risks, rollout: `implementation-plan-forecast-archive.md`
